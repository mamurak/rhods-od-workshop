 ...
 ** For the *Notebook Image* , select *TensorFlow* where Python is greater than 3.8 and tensorFlow greater than 2.4, as this 
 is the flavor of notebook we want to use. It includes the TensorFlow library, which is used to do object detection.
