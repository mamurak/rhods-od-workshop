...
+
--
We will create the test app using a pre-built container from a public contaner registry
...
Here is a *fedora* we captured earlier. 

image::s2i/app-screenshot.png[alt text, 400]

NOTE: If you don't want to type that long Route URL into your phone browser maybe you can paste it into an email to yourself?

*To finish the lab, see what your application can detect?*
