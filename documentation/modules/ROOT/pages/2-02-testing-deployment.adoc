...
Sometimes this action fails because your browser converts the URL to a secure protocol HTTPS route. Modify the 
URL in the browser to make sure it is *http://*
