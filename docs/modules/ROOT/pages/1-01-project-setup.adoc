...
* In OpenShift Console you have two perspectives, `Administrator` and `Developer`, between which you can easily switch by selecting `Developer` or `Administrator` respectively in the top field of the left menu.
...
Keep the OpenShift Console tab open for reference and return to the RHODS Dashboard tab.
